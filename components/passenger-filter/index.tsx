...
const Index = () => {
  return (
    <div className="bg-[#F1F3F6] pt-7 xl:pt-12">
      <nav className="bg-white mx-[15px] flex flex-col lg:flex-row gap-3 lg:gap-10 xl:gap-16 lg:justify-between p-5 rounded-[15px] font-poppins">
        <div className="flex justify-between flex-wrap flex-grow lg:gap-4 xl:gap-10">
          ...
          <div className="order-2">
            <h5 className="text-lg xl:text-xl font-semibold mb-2">14:20</h5>
            <p className="lg:text-xs xl:text-sm font-medium">31-Avg, Los A.</p>
          </div>
        </div>
